...
class InventarioResponseNotifier extends StateNotifier<InventarioResponseState>
{
  ...
  Future<void> generarReportePDF(DateTime fecha, int? cliente, int? planta) async 
  {
    ...
    final resultados = await repository.getInventarioPDF(fecha, cliente, planta);
    ...
    switch(resultados) {
      ...
      case Error():
        ...
        state = state.copyWith(isLoading: false, errorMessage: 'Hubo un problema al cargar el pdf de inventario');
    }
  }
