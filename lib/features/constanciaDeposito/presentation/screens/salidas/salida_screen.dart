...
class SalidaScreen extends ConsumerStatefulWidget 
{
  ...
  const SalidaScreen({super.key, required this.numUsuario});
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    ElevatedButton( /// BOTÓN CONSULTAR PDF
                      ...
                      onPressed: () {
                        context.push('/salidaPdf', extra: {'fechaInicio': fechaInicio, 'fechaFin': fechaFin, 'idCliente': clienteSeleccionado?.id, 'idPlanta': plantaSeleccionada?.id, 'idCamara': camaraSeleccionada?.id});
                      },
                      child: const Row(
